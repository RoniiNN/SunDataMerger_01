    ...
    for folder in folders:
        ...
        for file in file_name:
            if file.endswith(".csv"):
                ...
                with open(destination_filename + "printdata_1.csv", 'a', newline='') as weekly_data_output:
                    weekly_data_output.write(header_title_preset[0])
                    for i in faulty_list:
                        weekly_data_output.write(i)

                # NEW CODE BLOCK END HERE
...
def json_combine():
    ...
    while len(json_all_files) > 0:
        ...
        try:
            ...
            unit1_empty = "[Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null,Null]"
...
enter_id_label = Label(window, text="Enter Site ID:", background=Preset_color_gray)
enter_id_label.config(font=("Helvetica", 11, "roman italic"), fg=Preset_color_white)
